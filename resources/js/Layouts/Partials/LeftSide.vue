...
<template>
    <aside
        id="sidebar"
        class="flex hidden fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-16 w-64 h-full duration-200 lg:flex transition-width lg:w-64"
        aria-label="Sidebar"
    >
            ...
            >
                ...
                <div
                    ...
                    style="
                        ...
                        margin: 0px;
                        transform: translate(184px, 277px);
                    "
                >
