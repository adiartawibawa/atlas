...
const classes = computed(() => {
    return props.active
        ? 'block pl-3 pr-4 py-2 border-l-4 border-indigo-400 dark:border-gray-400 text-base font-medium text-indigo-700 bg-indigo-50 dark:bg-gray-700 dark:text-white focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition'
